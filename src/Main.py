...
if __name__ == "__main__":
    ...
    # train_data.read_data_from_file("D:\\Projects\\LeafRecognition\\data\\train_data_centroid.csv")
    ...
    #
    # print("Training...")
    # clf = RandomForestClassifier(n_estimators=4096, criterion="gini", n_jobs=-1)
    # clf.fit(train_features, train_labels)
    #
    # print("Reading test data...")
    # test_data = DataSet("test_data")
    # test_data.read_data_from_file("D:\\Projects\\LeafRecognition\\data\\test_data_centroid.csv")
